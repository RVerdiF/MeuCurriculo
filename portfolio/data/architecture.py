...
ARCHITECTURE: tuple[ArchNode, ...] = (
    ...
    ArchNode(
        ...
        stage=2,
        kind="store",
        summary="What arrived, as it arrived, but typed and traceable.",
    ...
    ArchNode(
        ...
        patterns=(
            ...
            "Documented models so the definition is not a rumor",
    ...
    ArchNode(
        ...
        patterns=("Dimensional modeling", "Stored procedures for repeated logic"),
    ...
    ArchNode(
        ...
        role="Remove the human step from the process",
    ...
    ArchNode(
        ...
        kind="serve",
        branch="ai",
        summary="Models and agents that carry the workflow through.",
    ...
    ArchNode(
        ...
        kind="process",
        branch="cross",
        summary="The same artifact runs everywhere it is deployed.",
        role="Cross-cutting",
    ...
    ArchNode(
        ...
        kind="process",
        branch="cross",
        summary="Definitions, quality and access are engineering artifacts.",
        role="Cross-cutting",
